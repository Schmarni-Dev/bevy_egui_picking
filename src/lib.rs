    ...
    fn from(event: ListenerInput<Pointer<Down>>) -> Self {
        Self {
            ...
            button: match event.button {
                bevy_mod_picking::pointer::PointerButton::Primary => PointerButton::Primary,
                bevy_mod_picking::pointer::PointerButton::Secondary => PointerButton::Secondary,
                bevy_mod_picking::pointer::PointerButton::Middle => PointerButton::Middle,
            },
        }
    }
}
